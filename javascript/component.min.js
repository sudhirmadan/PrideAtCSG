...
this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.pictureListForm.leftBtn.changeButtonColor(this.mainColor);this.pictureListForm.rightBtn.changeButtonColor(this.mainColor);this.changeItemColor()}}).extend(PcPrintFrame);var PcTableOfContentItem=Class({create:function(a,b,c){b.fontColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this._super(a,b,c)}}).extend(TableOfContentItem);var PcTableOfContentForm=Class({create:function(a){this._super(a)},initColorCss:function(){this.stage.css({"background-color":"transparent",color:this.mainColor});this.content.css({"background-color":this.fontColorObj.rgba(.9*this.formOpacity),color:this.mainColor});this.titleContainer.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});this.progressBar.css({"background-color":this.mainColorObj.rgba(.8)})},resetFormItems:function(){this.elements.refreshItems(this.mainColor)},
initHtml:function(){this.stage.addClass("form");this.titleContainer=$("<div class='title_content'></div>");this.titleContainer.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.titleContainer.append(this.close);this.stage.append(this.titleContainer);this.content=$("<div class='tableofcontent_content content_shadow'></div>");this.stage.append(this.content);this.content.append(this.tableofcontentSwiper);this.parent.append(this.stage)},
onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=300;this.height=a-85;this.maxHeight=this.height-23;this.stage.css({height:this.height+"px",top:b+"px"});this.tableofcontentSwiper.css("height",this.maxHeight+"px");this.elements.refresh()}}).extend(PcTableOfContentFrame);var PcVideoGalleryForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.stage.css({"background-color":"transparent",color:this.mainColor});this.content.css({"background-color":this.fontColorObj.rgba(.9),color:this.mainColor});this.titleContainer.css({"background-color":this.mainColor,color:this.fontColor})},initHtml:function(){this.titleContainer=$("<div class='title_content'></div>");this.titleContainer.append(this.title);this.favicon&&(bookConfig.RightToLeft?
this.title.append(this.favicon):this.title.prepend(this.favicon));this.titleContainer.append(this.close);this.stage.append(this.titleContainer);this.content=$("<div class='videoGallery_content content_shadow'></div>");this.stage.append(this.content);this.content.append(this.video);this.content.append(this.info);if(this.videoList&&1<this.videoList.length){var a=$("<div class='video_list'></div>");a.append(this.videoSwiper);this.content.append(a)}else this.stage.css("width","335px"),this.content.css("width",
"315px");this._super()}}).extend(PcVideoGalleryFrame);var PcShareForm=Class({create:function(a){this._super(a)},onCreate:function(){bookConfig.addCurrentPage&&this.content.css({height:"215px"});this.shareCode.css({"margin-top":"2px"});this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.7*this.formOpacity),color:this.fontColor});this.content.css({"background-color":this.fontColorObj.rgba(.9*this.formOpacity),color:this.mainColor});this.title.css({"background-color":this.mainColorObj.rgba(this.formOpacity)});
this.codeBox.find(".qrcode").css({"background-color":this.mainColor,color:this.fontColor});this.codeBox.find(".miniProgram").css({"background-color":this.mainColor,color:this.fontColor});this.copy1.css({"background-color":this.mainColor,color:this.fontColor})},initHtml:function(){this.titleContainer=$("<div class='title_content'></div>");this.titleContainer.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.titleContainer.append(this.close);
this.stage.append(this.titleContainer);this.content=$("<div class='share_content'></div>");this.initSwiper();this.stage.append(this.content);this.shareCurrentPageBox.append(this.shareCurrentCheck).append(this.shareCurrentPageTitle1);this.getQrCodeVisible&&this.content.append(this.codeBox);this.swiperContainer.append(this.sharePanelTitle);this.content.append(this.swiperContainer);this.linkBox.append(this.linkArea).append(this.copy1);this.content.append(this.shareCurrentPageBox);this.content.append(this.linkBox);
this._super()},changeItemColor:function(){this.elements.fontColor=this.mainColor;this.shareCurrentCheck.changeButtonColor(this.mainColor)},onShow:function(){var a=this;this.close.changeButtonColor(this.fontColor);this.changeItemColor();this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.shareStage.refreshData();this.elements.addItem(function(b){a.stage[0].style.display="inline-block";if(b){var c;null==(c=a.swiperContainer)||c.css({display:"none"})}})}}).extend(PcShareFrame);var PcDownloadForm=Class({create:function(a){this._super(a)},onCreate:function(){this._super()},initColorCss:function(){this.titleContainer.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});this.downloadContent.css({"background-color":this.fontColorObj.rgba(this.formOpacity),color:this.mainColor});this.downloadButton.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor});bookConfig.RightToLeft?this.content1.css({"border-left":"1px solid "+
...
this.pictureListForm.rightBtn.changeButtonColor(this.mainColor)},initHtml:function(){this.titleContainer=$("<div class='title_content'></div>");this.titleContainer.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));this.titleContainer.append(this.close);this.stage.append(this.titleContainer);this.downloadContent=$("<div class='download_content'></div>");this.stage.append(this.downloadContent);this.content=$("<div class='content'></div>");
this.content1=$("<div class='content1'></div>");downloadconfig.pdf&&this.content1.append(this.downloadAll);downloadconfig.hideDownloadSinglePage||this.content1.append(this.downloadCurrent);downloadconfig.attachments&&0<downloadconfig.attachments.length&&(this.content1.append(this.downloadAttachments),this.content1.append(this.selectAttachments));this.hasFiles?this.content1.append(this.downloadButton):this.content1.append(this.noFilesAvailablePrompt);this.content2=$("<div class='content2'></div>");
this.content2.append(this.pictureListForm.getDom());this.content.append(this.content1);this.content.append(this.content2);this.downloadContent.append(this.content);this._super()},gotoPage:function(a){this.pictureListForm.fillContent(a)}}).extend(PcDownloadFrame);
