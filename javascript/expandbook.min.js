...
p.callWhenSettled_(z.resolve,z.reject)};h.prototype.settleSameAsThenable_=function(p,z){var r=this.createResolveAndReject_();try{p.call(z,r.resolve,r.reject)}catch(B){r.reject(B)}};h.prototype.then=function(p,z){function r(Q,ca){return"function"==typeof Q?function(V){try{B(Q(V))}catch(da){D(da)}}:ca}var B,D,M=new h(function(Q,ca){B=Q;D=ca});this.callWhenSettled_(r(p,B),r(z,D));return M};h.prototype.catch=function(p){return this.then(void 0,p)};h.prototype.callWhenSettled_=function(p,z){function r(){switch(B.state_){case 1:p(B.result_);
break;case 2:z(B.result_);break;default:throw Error("Unexpected state: "+B.state_);}}var B=this;null==this.onSettledCallbacks_?n.asyncExecute(r):this.onSettledCallbacks_.push(r);this.isRejectionHandled_=!0};h.resolve=c;h.reject=function(p){return new h(function(z,r){r(p)})};h.race=function(p){return new h(function(z,r){for(var B=$jscomp.makeIterator(p),D=B.next();!D.done;D=B.next())c(D.value).callWhenSettled_(z,r)})};h.all=function(p){var z=$jscomp.makeIterator(p),r=z.next();return r.done?c([]):new h(function(B,
D){function M(V){return function(da){Q[V]=da;ca--;0==ca&&B(Q)}}var Q=[],ca=0;do Q.push(void 0),ca++,c(r.value).callWhenSettled_(M(Q.length-1),D),r=z.next();while(!r.done)})};return h},"es6","es3");$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};$jscomp.assign=$jscomp.TRUST_ES6_POLYFILLS&&"function"==typeof Object.assign?Object.assign:function(a,b){for(var c=1;c<arguments.length;c++){var g=arguments[c];if(g)for(var h in g)$jscomp.owns(g,h)&&(a[h]=g[h])}return a};
...
function(M){if(M instanceof c)return M;Object.isExtensible(M)&&h(M);return D(M)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var p="$jscomp_hidden_"+Math.random();n("freeze");n("preventExtensions");n("seal");var z=0,r=function(B){this.id_=(z+=Math.random()+1).toString();if(B){B=$jscomp.makeIterator(B);for(var D;!(D=B.next()).done;)D=D.value,this.set(D[0],D[1])}};r.prototype.set=function(B,D){if(!g(B))throw Error("Invalid WeakMap key");
h(B);if(!$jscomp.owns(B,p))throw Error("WeakMap key fail: "+B);B[p][this.id_]=D;return this};r.prototype.get=function(B){return g(B)&&$jscomp.owns(B,p)?B[p][this.id_]:void 0};r.prototype.has=function(B){return g(B)&&$jscomp.owns(B,p)&&$jscomp.owns(B[p],this.id_)};r.prototype.delete=function(B){return g(B)&&$jscomp.owns(B,p)&&$jscomp.owns(B[p],this.id_)?delete B[p][this.id_]:!1};return r},"es6","es3");$jscomp.MapEntry=function(){};
$jscomp.polyfill("Map",function(a){function b(){if($jscomp.ASSUME_NO_NATIVE_MAP||!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var r=Object.seal({x:4}),B=new a($jscomp.makeIterator([[r,"s"]]));if("s"!=B.get(r)||1!=B.size||B.get({x:4})||B.set({x:4},"t")!=B||2!=B.size)return!1;var D=B.entries(),M=D.next();if(M.done||M.value[0]!=r||"s"!=M.value[1])return!1;M=D.next();return M.done||4!=M.value[0].x||"t"!=M.value[1]||!D.next().done?!1:!0}catch(Q){return!1}}
if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;var c=new WeakMap,g=function(r){this.data_={};this.head_=p();this.size=0;if(r){r=$jscomp.makeIterator(r);for(var B;!(B=r.next()).done;)B=B.value,this.set(B[0],B[1])}};g.prototype.set=function(r,B){r=0===r?0:r;var D=h(this,r);D.list||(D.list=this.data_[D.id]=[]);D.entry?D.entry.value=B:(D.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:r,value:B},D.list.push(D.entry),
...
h(this,r).entry)&&r.value};g.prototype.entries=function(){return n(this,function(r){return[r.key,r.value]})};g.prototype.keys=function(){return n(this,function(r){return r.key})};g.prototype.values=function(){return n(this,function(r){return r.value})};g.prototype.forEach=function(r,B){for(var D=this.entries(),M;!(M=D.next()).done;)M=M.value,r.call(B,M[1],M[0],this)};g.prototype[Symbol.iterator]=g.prototype.entries;var h=function(r,B){var D=B&&typeof B;"object"==D||"function"==D?c.has(B)?D=c.get(B):
(D=""+ ++z,c.set(B,D)):D="p_"+B;var M=r.data_[D];if(M&&$jscomp.owns(r.data_,D))for(r=0;r<M.length;r++){var Q=M[r];if(B!==B&&Q.key!==Q.key||B===Q.key)return{id:D,list:M,index:r,entry:Q}}return{id:D,list:M,index:-1,entry:void 0}},n=function(r,B){var D=r.head_;return $jscomp.iteratorPrototype(function(){if(D){for(;D.head!=r.head_;)D=D.previous;for(;D.next!=D.head;)return D=D.next,{done:!1,value:B(D)};D=null}return{done:!0,value:void 0}})},p=function(){var r={};return r.previous=r.next=r.head=r},z=0;
...
w)}};return k[q]=e[q]=v}ja(q).forEach(function(x){var t=q[x];if(pa(t))f(x,q[x][0],q[x][1]);else{if("asap"!==t)throw new S.InvalidArgument("Invalid event config");var C=f(x,Za,function(){for(var y=arguments.length,A=Array(y);y--;)A[y]=arguments[y];C.subscribers.forEach(function(G){r(function(){G.apply(null,A)})})})}})}var k={};e.addEventType=f;for(var l=1,m=arguments.length;l<m;++l)f(arguments[l]);return e}function fb(d,e){return h(e).from({prototype:d}),e}function Ta(d,e){return!(d.filter||d.algorithm||
...
function(F){return F.toLowerCase()};q="next"===A?function(F){return F.toLowerCase()}:function(F){return F.toUpperCase()};u="next"===A?id:jd;var G=f.map(function(F){return{lower:q(F),upper:m(F)}}).sort(function(F,E){return u(F.lower,E.lower)});w=G.map(function(F){return F.upper});v=G.map(function(F){return F.lower});t="next"===(x=A)?"":k}var m,q,u,w,v,x,t,C=f.length;if(!f.every(function(A){return"string"==typeof A}))return va(d,"String expected.");l("next");d=new d.Collection(d,function(){return Fa(w[0],
v[C-1]+k)});d._ondirectionchange=function(A){l(A)};var y=0;return d._addAlgorithm(function(A,G,F){var E=A.key;if("string"!=typeof E)return!1;var H=q(E);if(e(H,v,y))return!0;for(var I=null,J=y;J<C;++J){var K=function(L,P,R,W,qa,ka){for(var T=Math.min(L.length,W.length),U=-1,X=0;X<T;++X){var Va=P[X];if(Va!==W[X])return 0>qa(L[X],R[X])?L.substr(0,X)+R[X]+R.substr(X+1):0>qa(L[X],W[X])?L.substr(0,X)+W[X]+R.substr(X+1):0<=U?L.substr(0,U)+P[U]+R.substr(U+1):null;0>qa(L[X],Va)&&(U=X)}return T<W.length&&"next"===
ka?L+R.substr(L.length):T<L.length&&"prev"===ka?L.substr(0,R.length):0>U?null:L.substr(0,U)+W[U]+R.substr(U+1)}(E,H,w[J],v[J],u,x);null===K&&null===I?y=J+1:(null===I||0<u(I,K))&&(I=K)}return G(null!==I?function(){A.continue(I+t)}:F),!1}),d}function Fa(d,e,f,k){return{type:2,lower:d,upper:e,lowerOpen:f,upperOpen:k}}function ma(){}function xa(d){return fa(function(e){return gb(e),d(e.target.error),!1})}function gb(d){d.stopPropagation&&d.stopPropagation();d.preventDefault&&d.preventDefault()}function ya(){}
...
v.keyPath,t=v.autoIncrement,C=pa(x),y={};t={name:v.name,primaryKey:{name:null,isPrimaryKey:!0,outbound:null==x,compound:C,keyPath:x,autoIncrement:t,unique:!0,extractKey:$b(x)},indexes:[].slice.call(v.indexNames).map(function(A){return v.index(A)}).map(function(A){var G=A.name,F=A.unique,E=A.multiEntry;A=A.keyPath;E={name:G,compound:pa(A),keyPath:A,unique:F,multiEntry:E,extractKey:$b(A)};return y[hb(A)]=E}),getIndexByKeyPath:function(A){return y[hb(A)]}};return y[":id"]=t.primaryKey,null!=x&&(y[hb(x)]=
t.primaryKey),t})},hasGetAll:0<m.length&&"getAll"in l.objectStore(m[0])&&!("undefined"!=typeof navigator&&/Safari/.test(navigator.userAgent)&&!/(Chrome\/|Edge\/)/.test(navigator.userAgent)&&604>[].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1])});f=q.schema;var u=q.hasGetAll;q=f.tables.map(function(v){var x=v.name;return{name:x,schema:v,mutate:function(t){var C=t.trans,y=t.type,A=t.keys,G=t.values,F=t.range;return new Promise(function(E,H){function I(U){++ka;gb(U)}function J(U){U=U.target.result;
...
!1,w.filter(function(y){return y._cfg.version>=e}).forEach(function(y){x.push(function(){var A=t,G=y._cfg.dbschema;ec(v,A,f);ec(v,G,f);t=v._dbSchema=G;var F=Mc(A,G);F.add.forEach(function(K){cc(f,K[0],K[1].primKey,K[1].indexes)});F.change.forEach(function(K){if(K.recreate)throw new S.Upgrade("Not yet support for changing primary key");var L=f.objectStore(K.name);K.add.forEach(function(P){return fc(L,P)});K.change.forEach(function(P){L.deleteIndex(P.name);fc(L,P)});K.del.forEach(function(P){return L.deleteIndex(P)})});
var E=y._cfg.contentUpgrade;if(E&&y._cfg.version>e){ac(v,f);m._memoizedTables={};C=!0;var H=Q(G);F.del.forEach(function(K){H[K]=A[K]});bc(v,[v.Transaction.prototype]);Db(v,[v.Transaction.prototype],ja(H),H);m.schema=H;var I,J=gc(E);J&&Sa();F=N.follow(function(){var K;(I=E(m))&&J&&(K=Aa.bind(null,null),I.then(K,K))});return I&&"function"==typeof I.then?N.resolve(I):F.then(function(){return I})}});x.push(function(A){var G;C&&qd||(G=y._cfg.dbschema,[].slice.call(A.db.objectStoreNames).forEach(function(F){return null==
G[F]&&A.db.deleteObjectStore(F)}));bc(v,[v.Transaction.prototype]);Db(v,[v.Transaction.prototype],v._storeNames,v._dbSchema);m.schema=v._dbSchema})}),function A(){return x.length?N.resolve(x.shift()(m.idbtrans)).then(A):N.resolve()}().then(function(){var A;ja(A=t).forEach(function(G){f.db.objectStoreNames.contains(G)||cc(f,G,A[G].primKey,A[G].indexes)})}).catch(q))})}function Mc(d,e){var f,k={del:[],add:[],change:[]};for(f in d)e[f]||k.del.push(f);for(f in e){var l=d[f],m=e[f];if(l){var q={name:f,
...
fb(sd.prototype,function(x,t){this.db=l;var C=Rc,y=null;if(t)try{C=t()}catch(G){y=G}var A=x._ctx;t=A.table;x=t.hook.reading.fire;this._ctx={table:t,index:A.index,isPrimKey:!A.index||t.schema.primKey.keyPath&&A.index===t.schema.primKey.name,range:C,keysOnly:!1,dir:"next",unique:"",algorithm:null,filter:null,replayFilter:null,justLimit:!0,isMatch:null,offset:0,limit:1/0,error:y,or:A.or,valueMapper:x!==Za?x:null}}));this.Table=(m=this,fb(td.prototype,function(x,t,C){this.db=m;this._tx=C;this.name=x;
this.schema=t;this.hook=m._allTables[x]?m._allTables[x].hook:eb(null,{creating:[ad,ba],reading:[$c,Za],updating:[cd,ba],deleting:[bd,ba]})}));this.Transaction=(q=this,fb(ud.prototype,function(x,t,C,y,A){var G=this;this.db=q;this.mode=x;this.storeNames=t;this.schema=C;this.chromeTransactionDurability=y;this.idbtrans=null;this.on=eb(this,"complete","error","abort");this.parent=A||null;this.active=!0;this._reculock=0;this._blockedFuncs=[];this._waitingQueue=this._waitingFor=this._reject=this._resolve=
...
unsubscribe:function(){u=!0;Ga.storagemutated.unsubscribe(y)}};l.start&&l.start(x);var t=!1,C=!1,y=function(G){Sc(w,G);m()&&A()},A=function(){var G,F;t||u||(w={},F=function(E){q&&Sa();var H=function(){return Ea(d,{subscr:E,trans:null})};H=O.trans?Ra(O.transless,H):H();return q&&H.then(Aa,Aa),H}(G={}),C||(Ga("storagemutated",y),C=!0),t=!0,Promise.resolve(F).then(function(E){f=E;t=!(e=!0);u||(m()?A():(w={},v=G,l.next&&l.next(E)))},function(E){e=t=!1;l.error&&l.error(E);x.unsubscribe()}))};return A(),
...
l.db===this.db?l===O.trans?l._promise(d,k,f):Ea(function(){return l._promise(d,k,f)},{trans:l,transless:O.transless||O}):function C(w,v,x,t){if(w.idbdb&&(w._state.openComplete||O.letThrough||w._vip)){var y=w._createTransaction(v,x,w._dbSchema);try{y.create(),w._state.PR1398_maxLoop=3}catch(A){return A.name===pc.InvalidState&&w.isOpen()&&0<--w._state.PR1398_maxLoop?(console.warn("Dexie: Need to reopen db"),w._close(),w.open().then(function(){return C(w,v,x,t)})):la(A)}return y._promise(v,function(A,
G){return Ea(function(){return O.trans=y,t(A,G,y)})}).then(function(A){return y._completion.then(function(){return A})})}if(w._state.openComplete)return la(new S.DatabaseClosed(w._state.dbOpenError));if(!w._state.isBeingOpened){if(!w._options.autoOpen)return la(new S.DatabaseClosed);w.open().catch(ba)}return w._state.dbReadyPromise.then(function(){return C(w,v,x,t)})}(this.db,d,[this.name],k)}finally{q&&bb()}},ha.prototype.get=function(d,e){var f=this;return d&&d.constructor===Object?this.where(d).first(e):
...
q(E,t[y][0])}:function(E){return 0<=q(E,t[y][0])},F=A;d=new this.Collection(this,function(){return Fa(t[0][0],t[t.length-1][1],!v,!x)});return d._ondirectionchange=function(E){C="next"===E?(F=A,m):(F=G,q);t.sort(f)},d._addAlgorithm(function(E,H,I){for(var J=E.key;F(J);)if(++y===t.length)return H(I),!1;return!A(J)&&!G(J)||(0===k._cmp(J,t[y][1])||0===k._cmp(J,t[y][0])||H(function(){C===m?E.continue(t[y][0]):E.continue(t[y][1])}),!1)}),d},ma.prototype.startsWithAnyOf=function(){var d=V.apply(Pa,arguments);
...
e,e.Transaction.prototype]),Db(e,[e._allTables,e,e.Transaction.prototype,this._cfg.tables],ja(k),k),e._storeNames=ja(k),this},Gb.prototype.upgrade=function(d){return this._cfg.contentUpgrade=Lb(this._cfg.contentUpgrade||ba,d),this},Gb),wd={stack:"dbcore",name:"VirtualIndexMiddleware",level:1,create:function(d){return Y(Y({},d),{table:function(e){function f(t,C,y){var A=hb(t),G=q[A]=q[A]||[],F=null==t?0:"string"==typeof t?1:t.length;A=0<C;A=Y(Y({},y),{isVirtual:A,keyTail:C,keyLength:F,extractKey:$b(t),
unique:!A&&y.unique});return G.push(A),A.isPrimaryKey||u.push(A),1<F&&f(2===F?t[0]:t.slice(0,F-1),C+1,y),G.sort(function(E,H){return E.keyTail-H.keyTail}),A}function k(t){var C,y=t.query.index;return y.isVirtual?Y(Y({},t),{query:{index:y,range:(C=t.query.range,y=y.keyTail,{type:1===C.type?2:C.type,lower:Hb(C.lower,C.lowerOpen?d.MAX_KEY:d.MIN_KEY,y),lowerOpen:!0,upper:Hb(C.upper,C.upperOpen?d.MIN_KEY:d.MAX_KEY,y),upperOpen:!0})}}):t}var l=d.table(e),m=l.schema,q={},u=[];e=f(m.primaryKey.keyPath,0,
m.primaryKey);q[":id"]=[e];for(var w=0,v=m.indexes;w<v.length;w++){var x=v[w];f(x.keyPath,0,x)}return Y(Y({},l),{schema:Y(Y({},m),{primaryKey:e,indexes:u,getIndexByKeyPath:function(t){return(t=q[hb(t)])&&t[0]}}),count:function(t){return l.count(k(t))},query:function(t){return l.query(k(t))},openCursor:function(t){function C(F){return Object.create(F,{continue:{value:function(E){null!=E?F.continue(Hb(E,t.reverse?d.MAX_KEY:d.MIN_KEY,A)):t.unique?F.continue(F.key.slice(0,G).concat(t.reverse?d.MIN_KEY:
d.MAX_KEY,A)):F.continue()}},continuePrimaryKey:{value:function(E,H){F.continuePrimaryKey(Hb(E,d.MAX_KEY,A),H)}},primaryKey:{get:function(){return F.primaryKey}},key:{get:function(){var E=F.key;return 1===G?E[0]:E.slice(0,G)}},value:{get:function(){return F.value}}})}var y=t.query.index,A=y.keyTail,G=y.keyLength;return y.isVirtual?l.openCursor(k(t)).then(function(F){return F&&C(F)}):l.openCursor(t)}})}})}},xd={stack:"dbcore",name:"HooksMiddleware",level:2,create:function(d){return Y(Y({},d),{table:function(e){var f=
d.table(e),k=f.schema.primaryKey;return Y(Y({},f),{mutate:function(l){function m(t){var C,y,A=O.trans,G=t.keys||(C=k,"delete"===(y=t).type?y.keys:y.keys||y.values.map(C.extractKey));if(!G)throw Error("Keys missing");return"delete"!==(t="add"===t.type||"put"===t.type?Y(Y({},t),{keys:G}):Y({},t)).type&&(t.values=a([],t.values,!0)),t.keys&&(t.keys=a([],t.keys,!0)),y=G,("add"===(C=t).type?Promise.resolve([]):f.getMany({trans:C.trans,keys:y,cache:"immutable"})).then(function(F){var E=G.map(function(H,
I){var J,K,L,P=F[I],R={onerror:null,onsuccess:null};return"delete"===t.type?w.fire.call(R,H,P,A):"add"===t.type||void 0===P?(J=v.fire.call(R,H,t.values[I],A),null==H&&null!=J&&(t.keys[I]=H=J,k.outbound||M(t.values[I],k.keyPath,H))):(J=lc(P,t.values[I]),(K=x.fire.call(R,J,H,P,A))&&(L=t.values[I],Object.keys(K).forEach(function(W){ua.call(L,W)?L[W]=K[W]:M(L,W,K[W])}))),R});return f.mutate(t).then(function(H){var I=H.failures,J=H.results,K=H.numFailures;H=H.lastResult;for(var L=0;L<G.length;++L){var P=
...
E.add(P),F.add(P)):(F.add(f),E.add(f),q.indexes.forEach(function(W){return y(W.name).add(f)})),L})}}),t={get:function(C){return[u,new za(C.key)]},getMany:function(C){return[u,(new za).addKeys(C.keys)]},count:l,query:l,openCursor:l};return ja(t).forEach(function(C){x[C]=function(y){var A=O.subscr;if(A){var G=function(K){K="idb://"+e+"/"+k+"/"+K;return A[K]||(A[K]=new za)},F=G(""),E=G(":dels"),H=t[C](y),I=H[0];H=H[1];if(G(I.name||"").add(H),!I.isPrimaryKey){if("count"!==C){var J="query"===C&&v&&y.values&&
...
new Map;global.annotationCookieDB=new AnnotationCookieDB;global.annotationCookieDB.init().then(function(){g.migrateData()});this.repaintCookie=debounceAsyncByKey(this.debounceRepaintCookie,100,function(h){return h[2]})},getCookieName:function(a){var b=bookConfig.ClientBookId?bookConfig.ClientBookId:"";return window.location.href.replace(window.location.hash,"").replace(window.location.search,"")+b+a},getCookie:function(a){var b=this,c,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){return 1==
h.nextAddress?(null==(c=b.migrationStatusMap.get(a))?0:c.isDone)?h.jumpTo(2):h.yield(b.migrateLocalStorageToIndexedDB(a),2):4!=h.nextAddress?h.yield(global.annotationCookieDB.getCookie(a),4):(g=h.yieldResult)?h.return(g):h.return(null)})},migrateData:function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){return 1==b.nextAddress?b.yield(a.migrateLocalStorageToIndexedDB("Cookie"),2):b.yield(a.migrateLocalStorageToIndexedDB("Note"),0)})},migrateLocalStorageToIndexedDB:function(a){var b=
this,c,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){switch(h.nextAddress){case 1:c=b.migrationStatusMap.get(a)||{promise:null,isDone:!1};if(c.isDone)return h.return();if(!c.promise){h.jumpTo(2);break}return h.yield(c.promise,3);case 3:return h.return();case 2:return g=function(){var n,p,z,r,B;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:return D.yield(global.annotationCookieDB.getCookie(a),2);case 2:if(n=D.yieldResult)return D.return(n);
p=b.getCookieName(a);z=window.localStorage.getItem(p);if(!z)return D.return();B=r=JSON.parse(z);D.setCatchFinallyBlocks(3);return D.yield(global.annotationCookieDB.saveCookie(a,B),5);case 5:D.leaveTryBlock(0);break;case 3:D.enterCatchBlock(),D.jumpToEnd()}})}.call(b),b.migrationStatusMap.set(a,{promise:g,isDone:!1}),h.yield(g,4);case 4:b.migrationStatusMap.set(a,{promise:null,isDone:!0}),h.jumpToEnd()}})},hasCvsCookie:function(a){var b=this,c,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){switch(n.nextAddress){case 1:c=
...
getLanguage("lblCancel","cancel")+"</div>");this.centerBox.append(this.deleteAlertText);this.confirmBox.append(this.no).append(this.yes);this.deleteBox.append(this.centerBox).append(this.confirmBox);this.deleteBox.css({"z-index":"10000",background:"#fff","box-shadow":" 0 0 3px #bbb",display:"none",width:"228px",height:"164px",position:"absolute",top:"0",left:"0",bottom:"0",right:"0"});this.noteBox.append(this.deleteBox);this.confirmBox.find(".deleteBtn").bind("mouseenter",function(a){$(a.target).css({background:"rgba(11,11,11,0.1)"})}.bind(this));
this.confirmBox.find(".deleteBtn").bind("mouseleave",function(a){$(a.target).css({background:""})}.bind(this));this.yes.bind(_event._click,function(){var a=this;global.annotationCookie.deleteNoteCookie("Note",this.config.index,this.config.id).then(function(){a.container.remove();a.container=void 0;a.deleteBox.fadeOut(200)})}.bind(this));this.no.bind(_event._click,function(){this.deleteBox.fadeOut(200)}.bind(this))},setColorIndex:function(a){this.colorIndex=a},initPageConfig:function(){this.pageIndex=
this.config.index+1;BookInfo.getBook().pageArray.length&&BookInfo.getBook().pageArray[this.pageIndex]&&("slide"==bookConfig.FlipStyle.toLocaleLowerCase()&&BookInfo.isDoublePage(BookInfo.getBookType())?(BookInfo.getBook().pageArray[this.pageIndex].leftPage?this.page=BookInfo.getBook().pageArray[this.pageIndex].leftPage:BookInfo.getBook().pageArray[this.pageIndex].rightPage&&(this.page=BookInfo.getBook().pageArray[this.pageIndex].rightPage),rightToLeft&&BookInfo.getBook().pageArray[this.pageIndex].rightPage&&
(this.page=BookInfo.getBook().pageArray[this.pageIndex].rightPage)):this.page=BookInfo.getBook().pageArray[this.pageIndex].page,this.pageWidth=this.page.pageWidth,this.pageHeight=this.page.pageHeight,this.page.pageAttachments?(this.notePanelWidth=this.page.pageAttachments.pageWidth,this.notePanelHeight=this.page.pageAttachments.pageHeight):(this.notePanelWidth=this.parent.width(),this.notePanelHeight=this.parent.height()),isPhone()||isPad()?(this.noteBoxWidth=148<parseInt(this.notePanelWidth/2)?148:
parseInt(this.notePanelWidth/2),this.noteBoxHeight=80<parseInt(this.notePanelHeight/2)?80:parseInt(this.notePanelHeight/2)):(this.noteBoxWidth=228<parseInt(this.notePanelWidth/2)?228:parseInt(this.notePanelWidth/2),this.noteBoxHeight=100<parseInt(this.notePanelHeight/2)?100:parseInt(this.notePanelHeight/2)),this.noteBoxHeight>this.noteBoxWidth-20&&(this.noteBoxHeight=this.noteBoxWidth-20))},initColorItems:function(){var a=(this.noteBoxWidth-72)/7;4>a&&(a=4);for(var b=0;b<this.colorArr.length;b++){var c=
$("<span style='float:left;cursor:pointer;background:"+this.colorArr[b]+";margin: 9px 0 9px "+a+"px;width:12px;height:12px;display:inline-block;border-radius:50%;box-shadow:0 0 0 1px rgba(11,11,11,0.3);-webkit-box-shadow:0 0 0 1px rgba(11,11,11,0.3)'></span>");b==this.colorIndex&&(c.addClass("active").css({"box-shadow":"0 0 0 2px #4BA0FF","-webkit-box-shadow":"0 0 0 2px #4BA0FF"}),this.noteBox.css({background:this.colorArr[b]}));this.colorItemEvent(c,b);this.colorBox.append(c)}},colorItemEvent:function(a,
b){a.bind(_event._click,function(){this.colorBox.find("span").removeClass("active").css({"box-shadow":"0 0 0 1px rgba(11,11,11,0.3)","-webkit-box-shadow":"0 0 0 1px rgba(11,11,11,0.3)"});a.css({"box-shadow":"0 0 0 2px #4BA0FF","-webkit-box-shadow":"0 0 0 2px #4BA0FF"}).addClass("active");this.noteBox.css({background:this.colorArr[b]});this.setColorIndex(b);this.icon.html(this.getNoteSvg(this.colorArr[b]));this.saveNoteCookie()}.bind(this))},getNoteSvg:function(a){return'<svg style="position:absolute;top:0;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"><defs><style>.cls-1, .cls-2 {fill-rule: evenodd;}.cls-1 {opacity: 0.85;}</style></defs><path id="\u8930\u3222\u59f8_2" data-name="\u8930\u3222\u59f8 2" class="cls-1" d="M2,0H15.917A1.98,1.98,0,0,1,18,2V13l-5,5s-8.875.063-11,0-2-2.667-2-2.667-0.062-10.562,0-13S2,0,2,0Z"/><path  fill="'+
...
b.on("panstart",function(c){c=this.getPanPosition(c);this.X=c.x;this.Y=c.y;this.isfocus=!0}.bind(this));b.on("panend",function(c){var g=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){g.isfocus=!1;return h.yield(g.saveNoteCookie(),0)})}.bind(this));b.on("panmove",function(c){var g=this,h,n,p,z,r,B,D,M,Q,ca,V,da,na,sa;return $jscomp.asyncExecutePromiseGeneratorProgram(function(aa){switch(aa.nextAddress){case 1:if(!g.isfocus){aa.jumpTo(0);break}g.initPageConfig();h=global.annotationCookie.tranScale||
1;n=global.annotationCookie.scale||1;p=g.getPanPosition(c);z=p.x/n-g.X/n;r=p.y/n-g.Y/n;B=a.left()+z;D=a.top()+r;M=g.parent.offset();Q=parseInt((g.pageWidth-g.parent.width())/2);ca=(g.pageHeight-g.parent.height())/2;V=BookInfo.getCurrentPages();da=0;if(2>V.length){B<=-Q&&(B=-Q);B>=g.pageWidth-a.width()-Q&&(B=g.pageWidth-a.width()-Q);aa.jumpTo(3);break}if(Math.ceil(M.left-Q)>=parseInt(windowWidth/2)){aa.jumpTo(4);break}if(B<=-Q){B=-Q;aa.jumpTo(3);break}if(!(p.x>=M.left+g.pageWidth+a.width()/2-Q&&2==
...
!0;a=this.docViewBook.offset().left;var b=this.docViewBook.offset().top;a-=this.docViewBook.parameters.left;b-=this.docViewBook.parameters.top;var c=this.docViewBook.parameters.scale,g=transformCSS({tran:{x:a,y:b},scale:c,origin:{x:0,y:0}}),h=this.pageArray.length,n=parseInt(this.width*c),p=parseInt(this.height*c);console.log(this.width,this.height,this.width*c);for(var z=0;z<h;z++)if(this.pageArray[z])for(var r=this.pageArray[z].pageArray,B=0;B<r.length;B++)if(r[B]){var D=r[B];if(D.pageAttachments){var M=
...
1)&&0<b||this.currentPageIndex===c&&0>b){var g=0,h=0;g=b;this.animateInterval=function(n,p){n=$.easing.easeOutBack(null,h,0,g,20);0<h&&(n-=$.easing.easeOutBack(null,h-1,0,b,20));console.log("movedTrans",n,b);for(p=0;p<this.pageArray.length;p++){var z=this.pageArray[p];if(z){var r=parseFloat(z[a]);z[a]=r-n;r=transformCSS({tran:{x:z.left,y:z.top}});z.setCSSByStyle(r)}}h++}.animation(this,320)}}},startInertialScroll:function(a){var b=this;this.animationId&&this.stopAnimation();var c=performance.now(),
g=c,h=a,n=0,p=0,z=a,r=bookConfig.FlipDirection||bookConfig.upsideOnMobile(),B=r?"top":"left",D=r?"height":"width",M=bookConfig.RightToLeft?bookConfig.totalPageCount:1,Q=bookConfig.RightToLeft?1:bookConfig.totalPageCount,ca=function(V){var da=Math.min(V-g,32);h=a=h+.25*(1.3*z*(1-(1-Math.pow(1-Math.min((V-c)/1500,1),3)))-h);n+=a*da;.35<=Math.abs(n)&&(da=Math.round(p+.3*(Math.round(n)-p)),0!==da&&b.panBookForMove(da,!0),n-=da,p=da);da=parseFloat(b.pageArray[b.currentPageIndex][B]);.1>Math.abs(a)||b.currentPageIndex===
